						...
						<div class="col-xs-12">
							...
							<!-- 所有 -->	
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="usernumber" value="${user.usernumber }"  for="form-field-1"  class="js_usernumber col-xs-10 col-sm-5" />
										</div>
									</div>
									<div class="space-4"></div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="username"  value="${user.username }" for="form-field-1"  class="js_username col-xs-10 col-sm-5" />
										</div>
									</div>
									<div class="space-4"></div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="password" name="password"  value="${user.password }" for="form-field-1"  class="js_password col-xs-10 col-sm-5" />
										</div>
									</div>
									<div class="space-4"></div>
						...
						<!-- 所有 -->		
							<div class="form-group">
								...
								<div class="space-4"></div>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 注册日期 </label>
