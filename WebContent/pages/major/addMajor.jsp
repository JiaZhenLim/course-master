...
<div class="main-content">
    <div class="breadcrumbs" id="breadcrumbs">
        ...
        <ul class="breadcrumb">
            ...
            <li>
                <a href="userListByPage.do?pageSize=10&pageNum=1">组织管理</a>
                <!--<a href="majorListByPage.do">组织管理</a>-->
            </li>
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <form class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1">组织名称
                        </label>
