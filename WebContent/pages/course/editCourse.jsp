            ...
            <div class="col-xs-12">
                ...
                <form class="js_form form-horizontal" role="form" action="editCourse.do">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="coursenumber" value="${course.coursenumber }" for="form-field-1"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="name" value="${course.name}" for="form-field-1"
                    ...
                    <%--<div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="credit" value="${course.credit}" for="form-field-1"
                                   class="js_credit col-xs-10 col-sm-5"/>
                        </div>
                    </div>
                    <div class="space-4"></div>--%>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <select
                                    <c:if test="${sessionScope.user.identity ==1}">disabled</c:if> name="teacherid"
                                    class="js_select_role col-xs-10 col-sm-5" for="form-field-1">
                                <c:forEach items="${teachers }" var="teacher">
                                    <option value="${teacher.id }"
                                            <c:if test="${course.teacherid == teacher.id}">selected</c:if>>${teacher.username }</option>
                                </c:forEach>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="schooltime" value="${course.schooltime}" for="form-field-1"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="address" value="${course.address}" for="form-field-1"
                                   class="js_address col-xs-10 col-sm-5"/>
                        </div>
                    </div>
                    <div class="space-4"></div>
                            ...
                            <select name="specialtyid" class="js_select_role col-xs-10 col-sm-5" for="form-field-1">
                                <c:forEach items="${majors }" var="major">
                                    <option value="${major.id }"
                                            <c:if test="${course.specialtyid == major.id}">selected</c:if>>${major.name }</option>
                                </c:forEach>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="numberlimit" value="${course.numberlimit}" id="form-field-1"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input id="form-field-3" type="text"
                                   value="<fmt:formatDate value='${course.createtime }'  type="date" pattern='yyyy-MM-dd'/>"
        ...
        if ($(".js_identity").val() == 1) {//如果为老师，只能修改一次
            layer.confirm('您只能修改一次，确定修改吗', {icon: 3, title: '提示'}, function (index) {
                $.post($(".js_form").attr("action") + "?createTime=" + $(".js_createTime").val(), course, function (data) {
                    ...
                    if (data == true) {
                        layer.alert('正在申请!', {icon: 6, time: 2000});
                        course.isAgree=null;
                    } else {
