    ...
    <div class="breadcrumbs" id="breadcrumbs">
        ...
        <ul class="breadcrumb">
            ...
            <li>
                ...
                <!--<a href="pages/college/college.jsp">学院管理</a>-->
            </li>
                        ...
                        <div class="modal-footer no-margin-top">
                            ...
                            <ul class="pagination pull-right no-margin">
                                    ...
                                    <li class="prev">
                                        ...
                                        <c:if test="${pageNum-1 > 0}">
                                            <li class="prev">
                                                <a href="collegeListByPage.do?pageSize=10&pageNum=${pageNum-1}">
                                ...
                                <c:if test="${pageNum+4 <= totalPage}">
                                    <c:forEach var="page" begin="${pageNum}" end="${pageNum +4 }">
                                        <li>
                                            <a href="collegeListByPage.do?pageSize=10&pageNum=${page}">${page }</a>
                                        </li>
                                    </c:forEach>
                                </c:if>
